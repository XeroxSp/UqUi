...
function Library.xova()
	...
	TweenService:Create(Main,TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{Size = UDim2.new(0, 520, 0, 374)}):Play()
	...
	Topbar.Size = UDim2.new(0, 544, 0, 60)
	...
	Scrollbar.Size = UDim2.new(0, 445, 0, 35)
	...
	Main2.Size = UDim2.new(0, 510, 0, 360)
